...
import com.tgb.controller.GpxProcessorRouteWInters;
...
/** 
* Select the points/segments on the map.
 */

public class DrawMapRoute extends JLabel implements KeyListener, MouseListener, MouseWheelListener, MouseMotionListener {
	...
	private GpxProcessorRouteWInters myExporter;
	...
	public DrawMapRoute(GpxProcessorRouteWInters exporterGpxMulti) {
...
//		frame.setVisible(true);
	...
	public void keyPressed(KeyEvent e) {
		...
		else if (e.getKeyCode() == KeyEvent.VK_PLUS || e.getKeyCode() == KeyEvent.VK_SEPARATOR)
		{
			zoom+=0.1;
			this.repaint();
		}
