...
//OTHER METHODS
	...
	public void export(Map<String,Element> elements, File outputFolder) throws IOException {
		...
		StringBuilder csvWaysBuild = new StringBuilder("isVisible;latitude;longitude;difflat;difflong;tags");
		...
		for(String id : elements.keySet()) {
			...
			if(currentElem instanceof Node) {
				...
				csvWaysBuild.append(";\"["+lonPrev+";"+latPrev+";0;0");
				...
				for(int i=1; i < currentWay.getNodes().size(); i++) {
					...
					csvWaysBuild.append("|"+lonCur+";"+latCur+";"+diffLon+";"+diffLat);
